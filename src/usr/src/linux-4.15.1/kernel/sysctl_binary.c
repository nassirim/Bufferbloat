...
static const struct bin_table bin_net_ipv4_table[] = {
	...
	{ CTL_INT,      NET_TCP_FLG_BUFFERBLOAT,                "tcp_flg_bufferbloat" },
	{ CTL_INT,	NET_TCP_MSS_MAX_THRESHOLD,		"tcp_mss_max_threshold" },
	{ CTL_INT,	NET_TCP_MSS_MIN_THRESHOLD,		"tcp_mss_min_threshold" },
	{ CTL_INT,	NET_TCP_RTT_MAX_THRESHOLD,		"tcp_rtt_max_threshold" },
	{ CTL_INT,	NET_TCP_RTT_MIN_THRESHOLD,		"tcp_rtt_min_threshold" },
	{ CTL_INT,	NET_TCP_RTT_EFFECTIVE_VALUE,		"tcp_rtt_effective_value" },
