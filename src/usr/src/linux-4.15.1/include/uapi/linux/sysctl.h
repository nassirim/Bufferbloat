...
enum
{
	...
	NET_TCP_FLG_BUFFERBLOAT=0,
	NET_TCP_MSS_MAX_THRESHOLD=1400,
	NET_TCP_MSS_MIN_THRESHOLD=80,
	NET_TCP_RTT_MAX_THRESHOLD=800,
	NET_TCP_RTT_MIN_THRESHOLD=100,
	NET_TCP_RTT_EFFECTIVE_VALUE=400,
