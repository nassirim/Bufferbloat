...
/* Added by Ali */
/* static int sysctl_tcp_flg_bufferbloat __read_mostly; */
...
static struct ctl_table ipv4_net_table[] = {
	...
	{
                .procname       = "tcp_flg_bufferbloat",
                .data           = &init_net.ipv4.sysctl_tcp_flg_bufferbloat,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
        {
                .procname       = "tcp_mss_max_threshold",
                .data           = &init_net.ipv4.sysctl_tcp_mss_max_threshold,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
        {
                .procname       = "tcp_mss_min_threshold",
                .data           = &init_net.ipv4.sysctl_tcp_mss_min_threshold,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
	{
                .procname       = "tcp_rtt_max_threshold",
                .data           = &init_net.ipv4.sysctl_tcp_rtt_max_threshold,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
        {
                .procname       = "tcp_rtt_min_threshold",
                .data           = &init_net.ipv4.sysctl_tcp_rtt_min_threshold,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
        {
                .procname       = "tcp_rtt_effective_value",
                .data           = &init_net.ipv4.sysctl_tcp_rtt_effective_value,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = proc_dointvec
        },
